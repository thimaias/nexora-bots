...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/3 left-10 md:left-24 animate-bounce duration-[4000ms] opacity-40">
      ...
      <div className="absolute bottom-1/3 right-8 md:right-28 animate-pulse duration-[3000ms] opacity-40">
